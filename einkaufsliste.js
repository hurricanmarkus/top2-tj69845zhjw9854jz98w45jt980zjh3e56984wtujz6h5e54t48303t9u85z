...
function moveStoreCategoryDraft(catId, dir) {
    if (!state.storeCategoryEditor) return;
    const order = [...state.storeCategoryEditor.categoryOrder];
