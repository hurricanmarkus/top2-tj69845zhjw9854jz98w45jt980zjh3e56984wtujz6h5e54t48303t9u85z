// ========================================
// GESCHENKE IMPORT - VEREINFACHTE VERSION
// ========================================
// ANLEITUNG:
// 1. Öffne TOP2-App und gehe zum Geschenkemanagement
// 2. Öffne Browser-Console (F12)
// 3. Kopiere ALLES und füge es in die Console ein
// 4. Drücke Enter
// 5. Tippe: startImport()
// ========================================

// DEINE DATEN HIER (Semikolon-getrennt)
...
async function startImport() {
    ...
    console.log(`📊 ${geschenke.length} Geschenke, ${themen.size} Themen, ${kontakte.size} Kontakte`);
    ...
    try {
        ...
        console.log('');
        console.log('🎉 FERTIG!');
        console.log(`✅ ${themen.size} Themen`);
        console.log(`✅ ${kontakte.size} Kontakte`);
        console.log(`✅ ${n} Geschenke`);
        console.log('');
...
console.log('📝 1. Füge deine Daten in Zeile 13 ein (DATEN = `...`)');
console.log('🚀 2. Tippe: startImport()');
console.log('');
