...
// --- NEUE FUNKTIONEN FÜR GEFAHRENZONE (HIER WURDE DER FEHLER BEHOBEN) ---
...
async function toggleManualPollClose() {
    ...
    try {
        ...
        alertUser(`Umfrage wurde ${newStatus ? 'beendet' : 'wieder freigeben'}!`, "success");
        renderEditView(currentVoteData); // UI der Edit-Seite aktualisieren
...
// --- ENDE NEUE FUNKTIONEN ---
// HINWEIS: Die überflüssige "}"-Klammer am Ende der Datei wurde entfernt.